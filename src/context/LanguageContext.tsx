...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    contact_map_title: 'موقع مقر شركة ريمان في الرياض',
    contact_map_subtitle: 'حي الروضة، شارع الحسن بن علي — تفضل بزيارتنا لمناقشة مشروعك الهندسي أو ابدأ الملاحة فوراً',
    contact_map_directions: 'بدء الملاحة والاتجاهات',
    contact_map_copy: 'نسخ العنوان',
    contact_map_copied: 'تم نسخ العنوان بنجاح!',
    contact_map_status: 'مقر الشركة متاح لاستقبال العملاء',
    contact_map_coordinates: 'الإحداثيات الجغرافية',
    contact_map_view_google: 'عرض في تطبيق Google Maps',
  ...
  en: {
    ...
    contact_map_title: 'Reeman Office Location in Riyadh',
    contact_map_subtitle: 'Al-Rawdah District, Al-Hassan Ibn Ali St. — Visit our office to discuss your project or start navigation instantly',
    contact_map_directions: 'Get Navigation Directions',
    contact_map_copy: 'Copy Address',
    contact_map_copied: 'Address copied to clipboard!',
    contact_map_status: 'Office Open for Client Consultations',
    contact_map_coordinates: 'GPS Coordinates',
    contact_map_view_google: 'View in Google Maps App',
